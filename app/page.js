      ...
      >
        <div className="relative z-10 w-full max-w-4xl mx-auto h-screen flex flex-col items-center justify-center text-center">
          ...
          <div className="absolute bottom-8 left-8 z-20 flex flex-col items-center gap-2 transition-transform duration-300 hover:scale-110">
            ...
            />
            <p className="text-amber-300/80 text-[8px] md:text-xs uppercase tracking-[0.18em] font-semibold">Educational Sponsor</p>
          </div>
          ...
          <div className="absolute bottom-8 right-8 z-20 flex flex-col items-center gap-2 transition-transform duration-300 hover:scale-110">
            <Image
              ...
              className="w-16 md:w-24 h-auto object-contain"
            />
            <p className="text-amber-300/80 text-[8px] md:text-xs uppercase tracking-[0.18em] font-semibold">Powered By</p>
          </div>
        ...
        <div className="relative z-20 w-full max-w-6xl px-6 mx-auto">
          ...
          <div className="flex flex-col items-center gap-10">
            <div className="group flex flex-col items-center text-center">
              <div className="relative w-72 h-44 overflow-hidden transition-all duration-500 group-hover:scale-105">
                <img src="/first.png" alt="First place coin" className="absolute inset-0 w-full h-full object-contain" />
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 w-full max-w-3xl place-items-center">
              <div className="group flex flex-col items-center text-center">
                <div className="relative w-64 h-40 overflow-hidden transition-all duration-500 group-hover:scale-105">
                  <img src="/second.png" alt="Second place coin" className="absolute inset-0 w-full h-full object-contain" />
                </div>
              </div>

              <div className="group flex flex-col items-center text-center">
                <div className="relative w-56 h-36 overflow-hidden transition-all duration-500 group-hover:scale-105">
                  <img src="/third.png" alt="Third place coin" className="absolute inset-0 w-full h-full object-contain" />
                </div>
              </div>
            </div>
          </div>
