      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl">
          ...
          <p className="text-amber-100/90 text-base md:text-lg mb-8">
            The journey that started it all. Unplugged 1.0 marked the beginning of a new era in hackathons,
            bringing together brilliant minds from various colleges and backgrounds to collaborate,
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-amber-100/85 leading-relaxed">
                  Unplugged 1.0 set the foundation for what would become one of the most anticipated hackathons
                  in the country. The event created an inspiring environment where creativity flourished and
                  innovation took center stage. It proved that there was a strong appetite for meaningful
                  hackathons that go beyond just coding and focus on solving genuine real-world problems.
                </p>
              </div>
